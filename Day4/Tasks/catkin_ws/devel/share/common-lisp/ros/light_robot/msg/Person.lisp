...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name light_robot-msg:<Person> is deprecated: use light_robot-msg:Person instead.")))
...
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader light_robot-msg:age-val is deprecated.  Use light_robot-msg:age instead.")
  (age m))
